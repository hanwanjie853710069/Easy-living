...
func insertUserData(age            : String ,
...
func queryDataUser() ->User{
    ...
    for inf:User in fetchedObjects as! [User]{
        print(inf.age)
        print(inf.userName)
        print(inf.passWord)
        print(inf.nickName)
...
func modifyTheUserData(modifyName: String, modifyValue: String ) ->Bool{
    ...
    do {
        ...
        for user:User in fetchedObjects as! [User]{
            
            switch modifyName {
                
            case "age":
                user.age = modifyValue
                print("年龄")
                
            case "backgroundUrl":
                user.backgroundUrl = modifyValue
                print("背景url")
                
            case "heardUrl":
                user.heardUrl = modifyValue
                print("头像url")
                
            case "userName":
                user.userName = modifyValue
                print("用户名字")
                
            case "nickName":
                user.nickName = modifyValue
                print("昵称")
                
            case "passWord":
                user.passWord = modifyValue
                print("密码")
                
            default:
                user.sex = modifyValue
                print("性别修改")
    ...
    }catch {fatalError("重新保存-更新到数据库：\(error)")}
