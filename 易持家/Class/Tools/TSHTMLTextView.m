...
//    return text;
    ...
    NSString *replacedString = [aText stringByReplacingOccurrencesOfRegex:[OCTools getHtmlUrlImage] withString:replaceWithString options:RKLCaseless range:NSMakeRange(0, aText.length) error:nil];
